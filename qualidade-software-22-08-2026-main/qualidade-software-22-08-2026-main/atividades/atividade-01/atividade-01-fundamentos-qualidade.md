...
|  Alessandro Reis da Silva| O sistema deve apresentar corretamente os restaurantes filtrados de acordo com a especialidade selecionada pelo usuário. | Adequação funcional — correção funciona | O filtro precisa apresentar resultados compatíveis com a especialidade escolhida para que o usuário consiga encontrar restaurantes de acordo com seu interesse. | Selecionar diferentes especialidades e comparar os restaurantes apresentados com o filtro escolhido, verificando se os resultados correspondem à categoria selecionada. |
