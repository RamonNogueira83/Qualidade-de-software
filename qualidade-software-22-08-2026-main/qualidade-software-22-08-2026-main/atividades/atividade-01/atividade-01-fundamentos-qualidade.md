...
|------------|------------------------|-------------------------------------|---------------|--------------|
|  Alessandro Reis da Silva | Sistema de favoritos fluido | Usabilidade | Melhorar a qualidade do sistema | Comparei o sistema de favoritos com as outras plataformas |
|  Alessandro Reis da Silva| funcionamento de fazer e finalizar pedido | Usabilidade | Melhorar a qualidade do sistema. | Avalie como funciona os pedidos. |
